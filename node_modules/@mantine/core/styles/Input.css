.m_6c018570 {
  ...
  .m_6c018570[data-with-right-section]:has([data-combined-clear-section]) {
      --input-padding-inline-end: calc(var(--input-right-section-size) * 1.55);
    }
...
.m_82577fc2[data-position='right']:has([data-combined-clear-section]) {
      --section-size: calc(var(--input-right-section-size) * 1.55);
    }
