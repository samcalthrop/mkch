...
class ResizeSensor extends common_1.AbstractPureComponent {
    constructor() {
        var _a;
        super(...arguments);
        this.targetRef = (_a = this.props.targetRef) !== null && _a !== void 0 ? _a : (0, react_1.createRef)();
    ...
    componentDidMount() {
        ...
        this.observer =
            globalThis.ResizeObserver != null
                ? new ResizeObserver(entries => { var _a, _b; return (_b = (_a = this.props).onResize) === null || _b === void 0 ? void 0 : _b.call(_a, entries); })
                : undefined;
        this.observeElement();
    }
...
ResizeSensor.displayName = `${common_1.DISPLAYNAME_PREFIX}.ResizeSensor`;
