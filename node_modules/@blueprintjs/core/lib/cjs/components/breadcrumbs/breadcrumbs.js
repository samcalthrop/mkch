...
class Breadcrumbs extends common_1.AbstractPureComponent {
    constructor() {
        ...
        this.renderOverflow = (items) => {
            ...
            return ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)(popover_1.Popover, { placement: collapseFrom === common_1.Boundary.END ? "bottom-end" : "bottom-start", disabled: orderedItems.length === 0, content: (0, jsx_runtime_1.jsx)(menu_1.Menu, { children: orderedItems.map(this.renderOverflowBreadcrumb) }), ...popoverProps, children: (0, jsx_runtime_1.jsx)("span", { "aria-label": "collapsed breadcrumbs", role: "button", tabIndex: 0, ...overflowButtonProps, className: (0, classnames_1.default)(common_1.Classes.BREADCRUMBS_COLLAPSED, overflowButtonProps === null || overflowButtonProps === void 0 ? void 0 : overflowButtonProps.className) }) }) }));
        };
