 ...
 */
class Collapse extends common_1.AbstractPureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    render() {
        ...
        return (0, react_1.createElement)(this.props.component, {
            className: (0, classnames_1.default)(common_1.Classes.COLLAPSE, this.props.className),
            style: containerStyle,
        }, (0, jsx_runtime_1.jsx)("div", { className: common_1.Classes.COLLAPSE_BODY, ref: this.contentsRefHandler, style: contentsStyle, "aria-hidden": !isContentVisible, children: shouldRenderChildren ? this.props.children : null }));
    }
    componentDidMount() {
        this.forceUpdate();
