...
exports.CompoundTag = (0, react_1.forwardRef)((props, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { ...htmlProps, className: tagClasses, tabIndex: interactive ? tabIndex : undefined, ref: ref, children: [(0, jsx_runtime_1.jsxs)("span", { className: common_1.Classes.COMPOUND_TAG_LEFT, children: [(0, jsx_runtime_1.jsx)(icon_1.Icon, { icon: icon }), (0, jsx_runtime_1.jsx)(text_1.Text, { className: (0, classnames_1.default)(common_1.Classes.COMPOUND_TAG_LEFT_CONTENT, common_1.Classes.FILL), tagName: "span", children: leftContent })] }), (0, jsx_runtime_1.jsxs)("span", { className: common_1.Classes.COMPOUND_TAG_RIGHT, children: [!(0, utils_1.isReactNodeEmpty)(children) && ((0, jsx_runtime_1.jsx)(text_1.Text, { className: (0, classnames_1.default)(common_1.Classes.COMPOUND_TAG_RIGHT_CONTENT, common_1.Classes.FILL), tagName: "span", children: children })), (0, jsx_runtime_1.jsx)(icon_1.Icon, { icon: endIcon !== null && endIcon !== void 0 ? endIcon : rightIcon }), isRemovable && (0, jsx_runtime_1.jsx)(tagRemoveButton_1.TagRemoveButton, { ...props })] })] }));
});
