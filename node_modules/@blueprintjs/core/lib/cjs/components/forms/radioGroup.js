...
const RadioGroup = props => {
    ...
    const renderOptions = () => {
        return options === null || options === void 0 ? void 0 : options.map(option => ((0, react_1.createElement)(controls_1.Radio, { ...getRadioProps(option), key: option.value, labelElement: option.label || option.value })));
    };
