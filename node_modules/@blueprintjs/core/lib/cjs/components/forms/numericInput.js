...
class NumericInput extends common_1.AbstractPureComponent {
    constructor() {
        var _a;
        super(...arguments);
        this.numericInputId = common_1.Utils.uniqueId("numericInput");
        this.state = {
            currentImeInputInvalid: false,
            shouldSelectAfterUpdate: false,
            stepMaxPrecision: NumericInput.getStepMaxPrecision(this.props),
            value: (0, numericInputUtils_1.getValueOrEmptyValue)((_a = this.props.value) !== null && _a !== void 0 ? _a : this.props.defaultValue),
        };
        ...
        this.getCurrentValueAsNumber = () => Number((0, numericInputUtils_1.parseStringToStringNumber)(this.state.value, this.props.locale));
        this.handleButtonClick = (e, direction) => {
            var _a, _b;
            const delta = this.updateDelta(direction, e);
            const nextValue = this.incrementValue(delta);
            (_b = (_a = this.props).onButtonClick) === null || _b === void 0 ? void 0 : _b.call(_a, Number((0, numericInputUtils_1.parseStringToStringNumber)(nextValue, this.props.locale)), nextValue);
        };
        ...
        this.handleContinuousChange = () => {
            ...
            (_d = (_c = this.props).onButtonClick) === null || _d === void 0 ? void 0 : _d.call(_c, Number((0, numericInputUtils_1.parseStringToStringNumber)(nextValue, this.props.locale)), nextValue);
        };
        // Callbacks - Input
        // =================
