...
export const CompoundTag = forwardRef((props, ref) => {
    ...
    return (_jsxs("span", { ...htmlProps, className: tagClasses, tabIndex: interactive ? tabIndex : undefined, ref: ref, children: [_jsxs("span", { className: Classes.COMPOUND_TAG_LEFT, children: [_jsx(Icon, { icon: icon }), _jsx(Text, { className: classNames(Classes.COMPOUND_TAG_LEFT_CONTENT, Classes.FILL), tagName: "span", children: leftContent })] }), _jsxs("span", { className: Classes.COMPOUND_TAG_RIGHT, children: [!isReactNodeEmpty(children) && (_jsx(Text, { className: classNames(Classes.COMPOUND_TAG_RIGHT_CONTENT, Classes.FILL), tagName: "span", children: children })), _jsx(Icon, { icon: endIcon !== null && endIcon !== void 0 ? endIcon : rightIcon }), isRemovable && _jsx(TagRemoveButton, { ...props })] })] }));
});
