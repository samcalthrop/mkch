...
export class RangeSlider extends AbstractPureComponent {
    render() {
        ...
        return (_jsxs(MultiSlider, { ...props, children: [_jsx(MultiSliderHandle, { value: value[RangeIndex.START], type: "start", intentAfter: props.intent, htmlProps: handleHtmlProps === null || handleHtmlProps === void 0 ? void 0 : handleHtmlProps.start }), _jsx(MultiSliderHandle, { value: value[RangeIndex.END], type: "end", htmlProps: handleHtmlProps === null || handleHtmlProps === void 0 ? void 0 : handleHtmlProps.end })] }));
    }
    validateProps(props) {
        const { value } = props;
