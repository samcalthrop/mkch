...
export const RadioGroup = props => {
    ...
    const renderOptions = () => {
        return options === null || options === void 0 ? void 0 : options.map(option => (_createElement(Radio, { ...getRadioProps(option), key: option.value, labelElement: option.label || option.value })));
    };
