...
export class Collapse extends AbstractPureComponent {
    ...
    render() {
        ...
        }, _jsx("div", { className: Classes.COLLAPSE_BODY, ref: this.contentsRefHandler, style: contentsStyle, "aria-hidden": !isContentVisible, children: shouldRenderChildren ? this.props.children : null }));
    }
    componentDidMount() {
        this.forceUpdate();
