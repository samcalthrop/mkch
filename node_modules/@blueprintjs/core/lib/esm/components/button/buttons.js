...
function renderButtonContents(props) {
    ...
    return (_jsxs(_Fragment, { children: [loading && _jsx(Spinner, { className: Classes.BUTTON_SPINNER, size: SpinnerSize.SMALL }), _jsx(Icon, { icon: icon }), hasTextContent && (_jsxs(Text, { className: classNames(Classes.BUTTON_TEXT, textClassName), ellipsize: ellipsizeText, tagName: "span", children: [text, children] })), _jsx(Icon, { icon: endIcon !== null && endIcon !== void 0 ? endIcon : rightIcon })] }));
}
