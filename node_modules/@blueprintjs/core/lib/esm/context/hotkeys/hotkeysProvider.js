...
export const HotkeysProvider = ({ children, dialogProps, renderDialog, value, }) => {
    ...
    const dialog = (_a = renderDialog === null || renderDialog === void 0 ? void 0 : renderDialog(state, { handleDialogClose })) !== null && _a !== void 0 ? _a : (_jsx(HotkeysDialog, { ...dialogProps, isOpen: state.isDialogOpen, hotkeys: state.hotkeys, onClose: handleDialogClose }));
